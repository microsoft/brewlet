...
mvn clean package sh.brewlet:brewlet-maven-plugin:0.3.1:push \
...
the [GitHub release](https://github.com/microsoft/brewlet/releases/tag/v0.3.1) and
install them once:

```bash
curl -fLO https://github.com/microsoft/brewlet/releases/download/v0.3.1/brewlet-maven-plugin-0.3.1.jar
curl -fLO https://github.com/microsoft/brewlet/releases/download/v0.3.1/brewlet-maven-plugin-0.3.1.pom
mvn org.apache.maven.plugins:maven-install-plugin:3.1.4:install-file \
  -Dfile=brewlet-maven-plugin-0.3.1.jar \
  -DpomFile=brewlet-maven-plugin-0.3.1.pom
```
